...
bool mazeExplorer(char map[][MAZE_SIZE], location entryPoint, location exitPoint){
    ...
    /* Implement the function here (Lab 03-2) */
    // This function explores "map" to find the path from "entryPoint" to "exitPoint" using QUEUE
